...
///<reference path='AsyncMacroCommandTestCommand.ts'/>
...
module test
{
	 ...
	 */
	export class AsyncMacroCommandTest
	{
		/**
		...
		name:string = "PureMVC Util AsyncCommand - AsyncMacroCommmand class tests";
		 ...
		 *
		 */
		testAsyncMacroCommandExecute():void
		{
			// Create the VO
			var vo:MacroCommandTestVO = new MacroCommandTestVO(5);

			// Create the Notification (notification)
			var notification:puremvc.INotification = new puremvc.Notification( 'AsyncMacroCommandTest', vo );
			// Create the MacroCommand
			var command:puremvc.ICommand = new AsyncMacroCommandTestCommand();
